"""
First write unit tests outside the context of the ExperimentProcessor.
todo: Some elegant way of having checks on coordinates and applying operations only to desired traces in one place in code.
!  Didn't test that again here as data_processing/test_processor.py already took care of testing this once.
? Having some way of removing duplicate code would also allow to test it at one place.
"""
